...
# OnyX 3.9.7  (mac系统维护工具)
# Rectangle 0.48 中文版 (开源Mac窗口管理应用)
# Disk Map 2.6 (26)  (可视化磁盘清理工具)
# Tidy Up 5.4.3  (强大的重复文件清理工具) 
# Bartender 4 4.0.48  (方便的管理菜单栏图标)
# QWeather 1.1.1 (202104192)  (和风天气 - 最强Mac天气应用)
# QuickRes 4.8  (快速切换屏幕分辨率)
# Mission Control Plus 1.16  (快速退出隐藏应用及关闭窗口
# Performance Index 64 4.1.0  (mac性能测试工具) 
# FE File Explorer Pro 3.1 (一款功能强大的文件管理器)
# TechTool Pro 14.0.1  (强悍的mac测试及维护工具)
# Listen1 2.21.5 中文版 (全网付费VIP音乐免费听) 
# Sensei 1.4.6 (88) (新一代性能优化清理工具)
# spy-debugger 微信网页调试
# Scudo 2.0.1  (超赞的mac防火墙) 
